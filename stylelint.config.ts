...
export const baseConfig: ConfigOverride = {
  files: [],
...
export const tailwindcssConfig: ConfigOverride = {
  files: [],
  rules: {
    'at-rule-no-unknown': [
      true,
      {
        ignoreAtRules: ['apply', 'custom-variant', 'reference', 'source', 'theme', 'utility', 'variant'],
      },
    ],
    'function-no-unknown': [
      true,
...
export const prettierConfig: ConfigOverride = {
  files: [],
